...
const lineData: ChartData = {
    labels: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julio'],
    datasets: [
        {
            label: 'First Dataset',
        ...
        <div className="grid">
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            <span className="block text-500 font-medium mb-3">Alunos Ativos</span>
                    ...
                    <span className="text-green-500 font-medium">24 Alunos </span>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">desde a semana passada</span>
                </div>
            </div>
            ...
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-500">respondeu</span>
                </div>
            </div>
            ...
            <div className="col-12 xl:col-6">
                <div className="card">
                    ...
                    <DataTable value={products} rows={5} paginator responsiveLayout="scroll">
                        <Column header="Imagem" body={(data) => <img className="shadow-2" src={`/demo/images/product/${data.image}`} alt={data.image} width="50" />} />
                ...
                <div className="card">
                    ...
                    <ul className="list-none p-0 m-0">
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Camiseta Espaço</span>
                                <div className="mt-1 text-600">Roupas</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Adesivo Supernova</span>
                                <div className="mt-1 text-600">Accessorios</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Caderno Maravilhas</span>
                                <div className="mt-1 text-600">Escritório</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Estojo Preto Mate</span>
                                <div className="mt-1 text-600">Acessorios</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Camiseta Robôs</span>
                                <div className="mt-1 text-600">Roupas</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                ...
                <div className="card">
                    ...
                    <ul className="p-0 mx-0 mt-0 mb-4 list-none">
                        ...
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                ...
                                <span className="text-700">
                                    {' '}
                                    comprou uma camiseta azul para <span className="text-blue-500">79$</span>
                                </span>
                            </span>
                        </li>
                        <li className="flex align-items-center py-2">
                            ...
                            Seu pedido de retirada de <span className="text-blue-500 font-medium">2500$</span> foi iniciado.
                            </span>
                        </li>
                    </ul>
                    ...
                    <ul className="p-0 m-0 list-none">
                        ...
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                ...
                                <span className="text-700">
                                    {' '}
                                    comprou uma jaqueta preta para <span className="text-blue-500">59$</span>
                                </span>
                            </span>
                        </li>
                        ...
                        <li className="flex align-items-center py-2 border-bottom-1 surface-border">
                            ...
                            <span className="text-900 line-height-3">
                                Jane Davis
                                <span className="text-700"> postou uma nova pergunta sobre seu produto.</span>
                            </span>
                        </li>
