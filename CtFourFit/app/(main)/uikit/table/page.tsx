...
const TableDemo = () => {
    ...
    return (
        <div className="grid">
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable value={products} expandedRows={expandedRows} onRowToggle={(e) => setExpandedRows(e.data)} responsiveLayout="scroll" rowExpansionTemplate={rowExpansionTemplate} dataKey="id" header={header}>
                        ...
                        <Column field="namee" header="Namee" sortable />
                        <Column header="Imagee" body={imageBodyTemplate} />
            ...
            <div className="col-12">
                <div className="card">
                    <h5>Agrupamento de subcabeçalhos</h5>
                    <DataTable
                        value={customers3}
                        ...
                        responsiveLayout="scroll"
                    >
                        <Column field="name" header="Nome" style={{ minWidth: '200px' }}></Column>
                        <Column field="country" header="País" body={countryBodyTemplate} style={{ minWidth: '200px' }}></Column>
                        <Column field="company" header="Empresa" style={{ minWidth: '200px' }}></Column>
                        <Column field="status" header="Status" body={statusBodyTemplate} style={{ minWidth: '200px' }}></Column>
                        <Column field="date" header="Data" style={{ minWidth: '200px' }}></Column>
                    </DataTable>
                </div>
            </div>
        </div>
